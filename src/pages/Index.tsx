...
const mockVideos: Video[] = [
  {
    ...
    steps: [
      "Open Microsoft Teams application or web version",
      "Click on 'Teams' in the left sidebar",
      "Select 'Create team' or 'Join or create a team'",
      "Choose 'Create a team' option",
      "Select 'From a template' to view available templates",
      "Browse and select the appropriate template for your needs (Project, Department, etc.)",
      "Enter team name and description",
      "Configure privacy settings (Private, Public, or Org-wide)",
      "Add team members by email or name",
      "Set up initial channels based on template structure",
      "Customize channel names and settings as needed",
      "Review team settings and permissions",
  ...
  },
  {
    ...
    steps: [
      "Check your calendar invitation for the meeting link",
      "Click 'Join Microsoft Teams Meeting' link in the invitation",
      "Choose to join via Teams app or web browser",
      "Enter your name if joining as a guest",
      "Test your camera and microphone before joining",
      "Select camera and microphone preferences",
      "Click 'Join now' to enter the meeting",
      "Alternative: Dial the conference number for phone access",
      "Enter the conference ID when prompted",
      "Troubleshoot connection issues if needed",
      "Adjust audio/video settings once in the meeting",
      "Use meeting controls for mute, video, chat, and screen sharing"
    ],
    duration: "4:15",
  ...
  },
  {
    ...
    steps: [
      "Open Teams app on desktop, mobile, or web browser",
      "Navigate to calendar and find your meeting",
      "Click 'Join' button from the calendar event",
      "Wait in the meeting lobby if enabled",
      "Organize and participant will admit you to the meeting",
      "Once admitted, familiarize yourself with meeting controls",
      "Use the chat feature to communicate during the meeting",
      "Practice proper meeting etiquette (mute when not speaking)",
      "Raise hand feature to request to speak",
      "Understand participant permissions and restrictions",
      "Handle access restriction issues by contacting organizer",
      "Use reactions and engagement features appropriately",
      "Leave meeting politely when finished"
    ],
    duration: "4:15",
  ...
  },
  {
    ...
    steps: [
      ...
      "Navigate to 'Calls' in the left sidebar",
      "Click the 'Make a call' button or use the dial pad",
      "Search for contact by name or enter phone number",
      "Choose between audio or video call option",
      "Click the call button to initiate the call",
      "For group calls: Add multiple participants before calling",
      "Use call controls during the call (mute, video, screen share)",
      "Understand difference between calls and scheduled meetings",
      "Set up call forwarding in Teams settings if needed",
      "Configure call delegation for assistant access",
      "Optimize call quality through audio/video settings",
      "Access call history in the Calls section",
      "End call properly and add notes if needed"
    ],
    duration: "5:30",
